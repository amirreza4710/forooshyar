...
| ✅ | تست خودکار مسیر بحرانی (ثبت سفارش: قفل موجودی، رد سفارش کم‌موجودی، احراز هویت) با Vitest+Supertest | #11 |
| ✅ | ایندکس دیتابیس بر اساس کوئری‌های واقعی (`orders.created_at`, `customers.created_at`, `orders.customer_id`, `orders.user_id`) | #12 |
